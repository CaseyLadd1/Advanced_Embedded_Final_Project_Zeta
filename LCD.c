...
//					line 		specifies line number
//(0-5)
//                  col     specifies column number (0-20)
// 					string	pointer to NULL-terminated ASCII
// string
//  				value		16-bit number in unsigned
//  decimal format
// outputs: none
...
// inputs: 	x				specifies the x coordinate (0 to
// 127)
//					y 			specifies the y
//coordinate
//(0 to 127) 					color		specifies the color
//of the crosshair
// outputs: none
