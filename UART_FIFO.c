...
#define TXFIFOSIZE 512 // must be a power of 2
...
// return TXFIFOSUCCESS if successfulTx_UARTRoomType
...
unsigned short Rx_UARTFifo_Size(void) {
  if (Rx_UARTPutPt < Rx_UARTGetPt) {
    return ((unsigned short)(Rx_UARTPutPt - Rx_UARTGetPt +
                             (RXFIFOSIZE * sizeof(rx_UARTDataType))) /
